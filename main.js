...
var HiddenTextSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Blacklist words").setDesc("One word per line. Paragraphs containing any of these words will be hidden. Syncs via Obsidian Sync automatically.").addTextArea((text) => {
